...
A modular stealth foundation has been added under =stealth/=.

- See =docs/stealth_foundation.md= for setup and usage.
- Run sample scene with =love test/stealth_demo=.
